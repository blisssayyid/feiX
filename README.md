...
经过资料查证之后，`1_lbt6` 是飞秋版本号, `128` 表示等级（就和QQ的等级类似，小太阳或者小月亮）, `001C429D7F77` 表示MAC地址, `#0#0#0#4001#9` 暂时不知道是啥意思, `1513616262` 包序号，这里建议使用时间戳, 因为不可重复, 接下来 `sayyid` 是用户名, `CDC0` 是主机名, `6291457`是命令字，表示上下线
